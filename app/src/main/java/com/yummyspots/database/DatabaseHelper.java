package com.yummyspots.database;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private static final String DATABASE_NAME = "eating.lviv";
    private static final int DATABASE_VERSION = 1;
    private static final Class<?>[] tables = new Class<?>[]{Place.class};
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        try {
            ...
            LOG.error("Error when creating database tables", e);
    ...
    public void onUpgrade(SQLiteDatabase database, ConnectionSource connectionSource, int oldVersion, int newVersion) {
        if (newVersion > oldVersion) {
            try {
                ...
                LOG.error("Error when upgrading database tables", e);
